...
class Laporan extends CI_Controller {
    ...
    function opendir($sub1="",$sub2="",$sub3=""){
        $cek=array('aksi'=>"Index");
        if(in_array($cek, $this->akses)){
            $dir=$this->laporan_model->getDir($sub1,$sub2,$sub3);
    ...
    function download($dir1="",$dir2="",$dir3=""){
        ...
        if(empty($dir1)&&empty($dir2)&&empty($dir3)){
            $path = 'report/';
            $filename="REPORT";
        }else{
            if(empty($dir2)&&empty($dir3)){
                $path = 'report/' .$dir1 ."/";
                $filename="REPORT_".$dir1;
            }else{
                if(empty($dir3)){
                    $path = 'report/'.$dir1 ."/".$dir2 ."/";
                    $filename="REPORT_" .$bln[$dir2]."_".$dir1;
                }else{
                    $path = 'report/'.$dir1 ."/".$dir2 ."/".$dir3 ."/";
                    $filename="REPORT_".$dir3."_" .$bln[$dir2] ."_".$dir1 ;
                }
            }
        }
