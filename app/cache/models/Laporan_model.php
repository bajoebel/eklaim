...
class Laporan_model extends CI_Model
{
    ...
    function getDir($sub1="",$sub2="",$sub3=""){
        if(empty($sub1) && empty($sub2 && empty($sub3))){
            $this->db->select('log_dir_root as root, log_sub_dir1 as dir1, log_sub_dir2 as dir2, log_sub_dir3 as dir3,log_file as file');
            $this->db->group_by('log_sub_dir1');
        }else{
            if(empty($sub2) && empty($sub3)){
