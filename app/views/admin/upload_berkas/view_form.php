                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class ="text-error" id="err_kode_jenis"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <!--/div-->
                                    <span class ="text-error" id="err_nomr"></span>
                                </div>
                            </div>
                            <?php } else{ ?>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class ="text-error" id="err_id_daftar"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="no_bpjs" name="no_bpjs" placeholder="NO BPJS" value="<?php if(!empty($kunjungan)) echo $kunjungan->no_bpjs; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="no_ktp" name="no_ktp" placeholder="NO KTP" value="<?php if(!empty($kunjungan)) echo $kunjungan->no_ktp; ?>" readonly>
                                    <span class ="text-error" id="err_no_bpjs"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" placeholder="Tempat Lahir" value="<?php if(!empty($kunjungan)) echo $kunjungan->tempat_lahir; ?>" readonly>
                                    <span class ="text-error" id="err_tempat_Lahir"></span>
                                </div>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir" value="<?php if(!empty($kunjungan)) echo $kunjungan->tgl_lahir; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="hidden" class="form-control" id="grId" name="grId" value="<?php if(!empty($kunjungan)) echo $kunjungan->id_ruang; ?>" >
                                    <input type="text" class="form-control" id="grNama" name="grNama" placeholder="Poly Tujuan / Ruang Rawatan" value="<?php if(!empty($kunjungan)) echo $kunjungan->nama_ruang; ?>" readonly>
                                    <span class ="text-error" id="err_grId"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            if(empty($berkas)){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="id_berkas" id="id_berkas" onchange="inputTagihan()">
                                        ...
                                        <span class ="text-error" id="err_id_berkas"></span>
                                    </div>
                                </div>
                                <div id="tagihan"><input type="hidden" name="jml_tagihan" id="jml_tagihan"></div>
                                <?php
                            }else{
                                ?>
                                <div class="form-group">
                            ...
                            if(!empty($berkas)){
                                ...
                                $histori=$this->upload_berkas_model->getHistori($berkas->id_daftar);
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <span class ="text-error" id="err_halaman_berkas"></span>
                                    </div>
                                </div>
                                <div id="list_berkas">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select class="form-control" name="halaman_berkas" id="halaman_berkas" onchange="halamanBerkas()">
                                            ...
                                            for($i=1;$i<=50;$i++){
                                                ?>
                                                <option value="<?= $i ?>" <?php if($jml_halaman==$i) echo "selected"; ?>><?= $i ." Halaman" ?></option>
                                                <?php
                                            }
                                            ?>
                                ...
                                <div id="file_berkas">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <span class ="text-error" id="err_nama_file"></span>
                                        </div>
                                    </div>
                                </div>
                                <?php
        ...
        <div class="col-md-6">
            <div class="box box-success">
                            ...
                            if(!empty($histori)){
                                foreach ($histori as $h) {
                                    ...
                                    <tr>
                                        ...
                                        <td><div style='float:left'><?php echo $h->jml_halaman; ?> Halaman </div><div class='text-right'><a href='#' onclick='lihatDokumen("<?php echo $h->d_idfile ?>")'><span class='btn btn-success btn-xs '>Lihat</span></a></div>
                                        </td>
                                    </tr>
                                    <?php
                                }
                ...
                <div class="box-footer">
                    <div class="btn-group" id="pagination-detail"></div>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <!--div class="col-md-12"-->
                                    <div class="box box-success">
                                        ...
                                        <div class="box-footer">
                                            <div class="btn-group" id="pagination1"></div>
                                        </div>
                                    </div>
                                <!--/div-->
                            </div>
