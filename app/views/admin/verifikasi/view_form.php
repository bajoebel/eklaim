                                ...
                                <div id="divHistori" class="list-group">
                                    ...
                                    $jml_berkas_wajib=0;
                                        ...
                                        if(!empty($kunjungan->log_file)){
                                            ?>
                                            <a href="<?php echo base_url() .$kunjungan->log_dir_root ."/" .$kunjungan->log_sub_dir1."/" .$kunjungan->log_sub_dir2."/" .$kunjungan->log_sub_dir3."/".$kunjungan->log_sub_dir4."/" .$kunjungan->log_file; ?>" class="btn btn-danger btn-block" target="_blank"> Download Dokumen </a>
                                            <?php
                                        }
                                    ?>
                                </div>                
        ...
        <div class="col-md-8">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php //print_r($priview); 
                        if(!empty($priview)) $tgl_reg= "(" .$priview[0]->tgl_reg .")"; else $tgl_reg="";
                        ?>
                    FORM VERIFIKASI <?php if(!empty($kunjungan)) echo "SEP <b><span style='color:#c62525;font-weight:bold'>" .strtoupper($kunjungan->no_sep) .$tgl_reg ."</span></b>"; ?>  <?php if(!empty($priview)) echo "DOKUMEN <b>" .strtoupper($priview[0]->nama_berkas ); ?></b>
                    </h3>
                    <div class="box-tools">
                        <?php 
                        if(!empty($priview)) {
                            ...
                            if($sv==1){
                                ?>
                                <button class="btn btn-success btn-sm" onclick="batalVerifikasi('<?php echo $id_daftar; ?>','<?php echo $dokumen_id; ?>')">Sudah Diverifikasi</button>
                                <?php
                            }else{
                                ?>
